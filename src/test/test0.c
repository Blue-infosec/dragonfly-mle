...
static const char *CONFIG_LUA =
	"inputs = {\n"
	"   { tag=\"input\", uri=\"ipc://input.ipc\", script=\"filter.lua\", default_analyzer=\"test0\"}\n"
	"}\n"
	"\n"
	"analyzers = {\n"
	"    { tag=\"test0\", script=\"analyzer.lua\", default_analyzer=\"\", default_output=\"log0\"},\n"
	"}\n"
	"\n"
	"outputs = {\n"
	"    { tag=\"log0\", uri=\"file://test0.log\"},\n"
	"}\n"
	"\n";
