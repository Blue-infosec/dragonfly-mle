...
static const char *CONFIG_LUA =
	"inputs = {\n"
	"   { tag=\"input\", uri=\"ipc://input.ipc\", script=\"filter.lua\", default_analyzer=\"test3\"}\n"
	"}\n"
	"\n"
	"analyzers = {\n"
	"    { tag=\"test3\", script=\"analyzer.lua\", default_analyzer=\"\", default_output=\"log3\" },\n"
	"}\n"
	"\n"
	"outputs = {\n"
	"    { tag=\"log3\", uri=\"file:///dev/null\"},\n"
	"}\n"
	"\n";
